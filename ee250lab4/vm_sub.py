...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("pjariwal/ipinfo")
    client.subscribe("pjariwal/date")
    client.subscribe("pjariwal/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("pjariwal/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("pjariwal/date", on_message_from_date)
    client.message_callback_add("pjariwal/time", on_message_from_time)
